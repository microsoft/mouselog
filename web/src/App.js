...
class App extends React.Component {
      ...
      if (this.state.isBot === 1) {
        return (
            <Alert variant="danger">
              <Alert.Heading>You Are Bot</Alert.Heading>
              <p>
                {this.state.rule}
              </p>
            </Alert>
        ...
        return (
            <Alert variant="success">
              <Alert.Heading>You Are Human</Alert.Heading>
            </Alert>
        )
      } else {
        return (
          <Alert variant="warning">
            <Alert.Heading>No Mouse Trace</Alert.Heading>
          </Alert>
        )
      }
    }
  ...
  render() {
    ...
    return (
      <div className="App fill-window" onMouseMove={(e) => this.mousemove(e)}>
